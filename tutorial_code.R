# Inputting the train and test datasets
...
# Replacing Gender variables
trainData$Sex = gsub("female", 1, trainData$Sex)
trainData$Sex = gsub("^male", 0, trainData$Sex)

# Making inference on missing age value
...
# Inputting title group averages
...
# Creating new variables in strengthen our model
# Variable 1: Child
trainData["Child"]
for (i in 1:nrow(trainData)) {
